        ...
        <Grid container spacing={1}>
          <Grid item xs={6} sm={4} md={3}>
            <TextField
              ...
              inputRef={register({
                required: { value: true, message: t('Zip Code is required') }
              })}
          ...
          <Grid item xs={12} sm={8} md={6}>
            <TextField
              ...
              inputRef={register({
                required: { value: true, message: t('Line 1 is required') }
              })}
              error={!!errors.line1}
          ...
          <Grid item xs={6} sm={4} md={3}>
            <TextField
              ...
              inputRef={register({
                required: { value: true, message: t('Number is required') }
              })}
              error={!!errors.number}
          ...
          <Grid item xs={6} sm={6} md={3}>
            <TextField
              ...
              inputRef={register({
                required: { value: true, message: t('Suburb is required') }
              })}
              error={!!errors.suburb}
